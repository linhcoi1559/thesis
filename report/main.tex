...
\begin{titlepage}
    ...
    \vspace{3cm}
    \includegraphics[width=0.4\textwidth]{usth.png} \par
    \vspace{2cm}
    {\huge \textbf{SMART BOARDING HOUSE MANAGEMENT SYSTEM} \par}
    \vspace{0.5cm}
    {\Large \textbf{BACHELOR THESIS REPORT} \par}
    \vspace{0.5cm}
    {\Large \textbf{RENTAL SAAS PLATFORM} \par}
    ...
    {\large \textbf{Internal Supervisor:} Trần Giang Sơn \par}
    \vspace{0.2cm}
    {\large \textbf{External Supervisor:} Lê Văn Sơn \par}
    \vspace{1.5cm}
    {\large Hanoi, 2026 \par}
    \thispagestyle{empty}
\end{titlepage}
\restoregeometry
...
\input{chapters/to_whom_it_may_concern}
...
\input{chapters/5_results_discussions}
\input{chapters/6_conclusion_future_work}
